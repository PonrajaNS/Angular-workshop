...
export class BookDetailComponent implements OnInit {
  ...
  bookId: number; book: Ibook; sub: Subscription;
  ...
  ngOnInit(): void {
    if (!this.bookId) {
      this.sub = this._route.params.subscribe(params => { let id = +params['id']; this.getBook(id); }); return;
  ...
  onRatingUpdate(book: Ibook): void { this.updateBook(book); }
  ...
  return(): void { this._router.navigate(['/collection']); }
